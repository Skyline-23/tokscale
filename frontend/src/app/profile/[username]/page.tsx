      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 py-10 w-full">
          ...
          <div className="flex items-start gap-6 mb-6">
            {data.user.avatarUrl ? (
              <img
                ...
                className="w-24 h-24 rounded-2xl ring-4 ring-gray-200 dark:ring-gray-700"
              />
            ) : (
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2">
                {data.sources.map((source) => (
                  <span
                    key={source}
                    className="px-2 py-1 text-xs font-medium bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 rounded-lg"
                  >
                    {source}
                  </span>
                ))}
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">Cache Read</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
                {formatNumber(data.stats.cacheReadTokens)}
              </p>
            </div>
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">Cache Write</p>
              <p className="text-lg font-semibold text-gray-900 dark:text-white">

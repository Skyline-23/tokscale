...
| <img width="48px" src=".github/assets/client-amp.png" alt="Amp" /> | [Amp](https://ampcode.com/) | `~/.local/share/amp/threads/` | ✅ Yes / from `v1.0.18` (next release) |
| <img width="48px" src=".github/assets/client-droid.png" alt="Droid" /> | [Droid (Factory.ai)](https://factory.ai/) | `~/.factory/sessions/` | ✅ Yes / from `v1.0.18` (next release) |
